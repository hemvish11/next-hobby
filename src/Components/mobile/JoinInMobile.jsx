...
const JoinInMobile = ({ signInOut,hamburgerClicked }) => {
                ...
                <div className="flex items-center justify-center">
                    ...
                    <div className="w-full">
                        ...
                        <form >
                            ...
                            {/* <!-- Email input --> */}
                            <div className="mb-4">
                                <input type="email" id="email" className="w-full px-2 lg:px-3 py-1.5 lg:py-2.5 border border-gray-300 bg-[#ebedf0] rounded-md focus:outline-none focus:border-blue-500 focus:ring focus:ring-blue-200" placeholder='Email' />
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    id="passwordInput"
                                    className="w-full px-2 lg:px-3 py-1.5 lg:py-2.5 border border-gray-300 bg-[#ebedf0] rounded-md focus:outline-none focus:border-blue-500 focus:ring focus:ring-blue-200"
                            ...
                            <div className="flex justify-between items-center mb-4">
                                ...
                                <div className="password-meter mb-3" >
                                    <div className={`meter-section rounded me-2 ${hamburgerClicked ? "bg-[#ebedf0]" : "bg-white"} ${strengthClasses[0]}`}><span className='bars'>Hiiiiiiiiiiiii</span></div>
                                    <div className={`meter-section rounded me-2 ${hamburgerClicked ? "bg-[#ebedf0]" : "bg-white"} ${strengthClasses[1]}`}><span className='bars'>Hiiiiiiiiiiiii</span></div>
                                    <div className={`meter-section rounded me-2 ${hamburgerClicked ? "bg-[#ebedf0]" : "bg-white"} ${strengthClasses[2]}`}><span className='bars'>Hiiiiiiiiiiiii</span></div>
                                </div>
                                {/* -------------------------Strength meter ends---------------------------------- */}
