                ...
                <div className="flex items-center justify-center">
                    ...
                    <div className="w-full">
                        ...
                        <form >
                            ...
                            {/* <!-- Email input --> */}
                            <div className="mb-4">
                                <input type="email" id="email" className="w-full px-2 lg:px-3 py-1.5 lg:py-2.5 border border-gray-300 rounded-md focus:outline-none focus:border-blue-500 focus:ring focus:ring-blue-200 bg-[#ebedf0]" placeholder='Email' />
                            </div>
                            ...
                            <div className="mb-4 relative">
                                <input
                                    ...
                                    id="passwordInput"
                                    className="bg-[#ebedf0] w-full px-2 lg:px-3 py-1.5 lg:py-2.5 border border-gray-300 rounded-md focus:outline-none focus:border-blue-500 focus:ring focus:ring-blue-200"
                            ...
                            <button
                                type="submit"
                                className="lg:border-2 lg:border-[#8064a2] hover:bg-[#745699]  py-2.5 px-4 text-white lg:text-black rounded-lg text-[12px] lg:text-[14px] w-full font-[600] bg-[#8064a2] lg:bg-[#f7f5f9]"
